...
class Page {
   ...
   private $_arrH = "";
   private $_arrAccordion = array();
   private $_strScript = "";
   private $_arrLink = array();
   private $_arrScript = array();
   private $_arrCte = array(
       'MSG_1' => MSG_1,
       'MSG_2' => MSG_2,
   ...
   private $_arrWatch0 = array('watchDarkly', 'watchCosmo', 'watchSlate', 'watchSuperHero');
   private $_arrTheme = array('bootable');
   private $_arrWatch = array();
   private $_themeItem = 0;
   
   private $_arrSugest = array('ALL', 'AS', 'ASC', 'CASE', 'CROSS', 'DELETE', 'DESC', 'DISTINCT', 'DISTINCTROW', 'DUMPFILE', 'DUPLICATE', 'ELSE', 'ELSEIF', 'FORCE', 'FROM', 'GROUP', 'GROUP_CONCAT', 'HAVING', 'INDEX', 'INNER', 'INSERT', 'INTO', 'JOIN', 'LEFT', 'LIMIT', 'ORDER', 'OUTER', 'REPLACE', 'RIGHT', 'SELECT', 'SHOW', 'THEN', 'UNION', 'UPDATE', 'USING', 'WHEN', 'WHERE', 'WHILE');
